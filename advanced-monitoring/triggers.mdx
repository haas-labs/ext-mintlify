...
description: "Customize Hacken Extractor triggers to fit your security requirements — fire alerts on function calls, events, transfers, and transaction parameters."
---
