...
description: "The Failed Transaction trigger fires when any transaction to the monitored smart contract is reverted or fails on-chain, surfacing exploit attempts."
---
