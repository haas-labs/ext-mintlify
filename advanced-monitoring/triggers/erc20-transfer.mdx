...
description: "The ERC-20 Transfer trigger fires whenever an ERC-20 token transfer above your configured threshold occurs on the monitored smart contract."
---
