...
description: "The Transaction Parameters trigger fires when any transaction or block parameter matches one or more rules you define on the monitored contract."
---
