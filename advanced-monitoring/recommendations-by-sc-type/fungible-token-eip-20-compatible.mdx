...
description: "Recommended Hacken Extractor triggers for ERC-20 / EIP-20 fungible token contracts — monitor minting, transfers, and supply changes for exploits."
---
