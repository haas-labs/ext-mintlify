---
title: "Aster DEX Monitor for financial monitoring"
description: "Track an Aster DEX account's portfolio value and asset market prices, alerting when user-defined financial conditions or thresholds are met."
---
