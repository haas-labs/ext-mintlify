---
title: "Total Supply Monitor for financial monitoring"
description: "Track the total circulating supply of a token on-chain and alert when the issued supply exceeds your expected threshold for financial monitoring."
---
