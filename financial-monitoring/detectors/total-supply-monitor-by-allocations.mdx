---
title: "Total Supply Monitor by Allocations (financial)"
description: "Track on-chain balances per tokenomics allocation address and emit daily allocation reports for financial monitoring of vesting and unlock schedules."
---
