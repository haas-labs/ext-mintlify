---
title: "TVL Monitor for financial monitoring"
description: "Monitor liquidity for ERC-20 tokens and native coins held by a contract, alerting when balances drop beyond a financial-monitoring threshold between blocks."
---
