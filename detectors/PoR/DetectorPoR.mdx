---
title: "Proof of Reserves Monitor (legacy)"
description: "Legacy Proof of Reserves Monitor — tracks contract or address reserves via Chainlink or CoinGecko feeds and alerts on configured thresholds."
---
...
![DetectorPoR Configuration](/assets/DetectorPoR-Config.png)
