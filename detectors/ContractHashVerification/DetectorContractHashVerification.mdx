---
title: "Contract Hash Verification (legacy)"
description: "Legacy Contract Hash Verification detector — watches contract bytecode for unexpected changes and alerts on mismatches against expected checksums."
---
