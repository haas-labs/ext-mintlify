...
description: "The Bubblemap Monitor uses Bubblemaps data to detect token holder centralization anomalies, alerting when concentration risk patterns appear on-chain."
---
...
![DetectorBubblemaps Configuration](/assets/DetectorBubblemaps-Config.png)
