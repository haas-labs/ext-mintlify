...
description: "The Chainlink ACE detector monitors contracts integrated with Chainlink's Automated Compliance Contract Engine for policy and rule violations."
---
...
![DetectorChainlinkACE Configuration](/assets/DetectorChainlinkACE-Config.png)
