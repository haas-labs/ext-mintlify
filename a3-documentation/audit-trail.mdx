---
title: "Audit Trail"
description: "Review every user action in your Hacken Extractor organization with the Audit Trail — a tamper-evident log of logins, changes, and configuration updates."
---

![Audit Trail page showing the log table with Entity, User, Date and time, Id, and Action columns, plus filter controls at the top](/assets/a3/audit-trail.png)
