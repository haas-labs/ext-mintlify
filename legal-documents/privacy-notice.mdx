...
We use cookies that are needed for the App's operation. By using cookies, we receive automatically collected data. You can read more in our [Cookies Policy](cookie-policy).
