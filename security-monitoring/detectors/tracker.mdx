---
title: "Tracker"
description: "The Tracker detector traces asset movements from a set of seed addresses and automatically labels every new address that funds touch on-chain."
---
