---
title: "Safe Multisig Monitor for security"
description: "Track Safe (Gnosis Safe) multisig activity — signer changes, transaction executions, and confirmations — to catch unauthorized governance changes."
---
...
The monitor generates the following event types:
