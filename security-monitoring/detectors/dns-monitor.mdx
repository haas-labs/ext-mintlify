---
title: "DNS Monitor for security"
description: "Monitor WHOIS and DNS records of project domains for hijacking, unauthorized changes, and impending expirations — early warning for phishing attacks."
---
