...
description: "The Extractor Attack Detector activates automatically when you add an address to Security Monitoring, flagging suspicious accounts and contracts."
---
...
_Name_ - Enter a descriptive name for your monitor, for example: "Attack Detector".
