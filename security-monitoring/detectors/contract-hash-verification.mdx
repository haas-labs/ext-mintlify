---
title: "Contract Hash Verification for security"
description: "Verify proxy contract upgrades against expected bytecode hashes, alerting whenever an unexpected or unauthorized implementation is deployed."
---
