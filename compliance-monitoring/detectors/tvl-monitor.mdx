---
title: "TVL Monitor for compliance"
description: "Track liquidity changes for ERC-20 tokens and native coins in a contract for compliance, alerting when balances drop beyond a threshold between blocks."
---
