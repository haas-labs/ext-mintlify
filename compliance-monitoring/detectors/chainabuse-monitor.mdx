...
description: "The Chainabuse Monitor analyzes reports from chainabuse.com with LLM filtering to flag phishing, ransomware, scams, and other malicious crypto activity."
---
...
<Steps>
  <Step title="Name">
    Enter a descriptive name for your monitor, for example: "Chainabuse Monitor".
  </Step>
  <Step title="Category (optional)">
...
![](../../assets/chainabuse_monitor_faq.png)

**Alert example**

![](../../assets/chainabuse_monitor_alert.png)
