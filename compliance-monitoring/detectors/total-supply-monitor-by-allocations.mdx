---
title: "Total Supply Monitor by Allocations (compliance)"
description: "Track on-chain balances per tokenomics allocation address and emit daily allocation reports, sourcing definitions from the Extractor API."
---
