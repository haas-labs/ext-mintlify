---
title: "Aster DEX Monitor for compliance"
description: "Track Aster DEX portfolio value changes and asset market prices for compliance reporting, with alerts when user-defined conditions are met."
---
