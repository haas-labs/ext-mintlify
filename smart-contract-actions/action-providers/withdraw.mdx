...
description: "Withdraw the remaining native token balance from an Action Provider back to your own wallet when retiring or rebalancing an automated signer."
---
