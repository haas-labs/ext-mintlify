...
description: "Create a smart contract action that executes automatically in response to Hacken Extractor monitoring events, or manually on demand from the dashboard."
---
